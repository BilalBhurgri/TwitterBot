...
def thread_gen():
    ...
    for paper_id in paper_ids:
        try:
            path = f"downloads/thread_downloads/Qwen3-4B/bot0/{paper_id}.json"
            if os.path.exists(path):
                ...
                for i in range(min([len(sentences), 5])):
                    ...
                    tweet = generate_tweet_qwen(sentences[i], tokenizer, model, bot_num=0)
                ...
                with open(f'downloads/threads/Qwen3-4B/bot0/{paper_id}.json', 'w') as f:
